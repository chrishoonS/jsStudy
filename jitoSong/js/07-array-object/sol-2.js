var quotes = []; //배열 초기화
quotes[0] = "당신은 지금도 최고고, 이전에도 최고였으며 앞으로도 최고일 것입니다."; //각 요소 선언
...
var index = Math.floor(Math.random() * 10); //index 변수에 0~1난수 * 10 저장 //0~1난수 * 10 = 정수
document.write("<p>&quot;" + quotes[index] + "&quot;</p>") //quotes 배열의 index를 무작위로 출력